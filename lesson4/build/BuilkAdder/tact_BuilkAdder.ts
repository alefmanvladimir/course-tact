...
export function loadCounterValue(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 454560690) { throw Error('Invalid prefix'); }
    let _amount = sc_0.loadUintBig(32);
    return { $$type: 'CounterValue' as const, amount: _amount };
}
...
function dictValueParserReach(): DictionaryValue<Reach> {
 ...
 type BuilkAdder_init_args = {
    $$type: 'BuilkAdder_init_args';
}

function initBuilkAdder_init_args(src: BuilkAdder_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
    };
}

async function BuilkAdder_init() {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initBuilkAdder_init_args({ $$type: 'BuilkAdder_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const BuilkAdder_errors: { [key: number]: { message: string } } = {
    ...
    61684: { message: `target can't be more than 10` },
}

const BuilkAdder_types: ABIType[] = [
    ...
    {"name":"CounterValue","header":454560690,"fields":[{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":32}}]},
...
const BuilkAdder_getters: ABIGetter[] = [
]

const BuilkAdder_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"Reach"}},
    {"receiver":"internal","message":{"kind":"typed","type":"CounterValue"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class BuilkAdder implements Contract {
    
    static async init() {
        return await BuilkAdder_init();
    }
    
    static async fromInit() {
        const init = await BuilkAdder_init();
        const address = contractAddress(0, init);
        return new BuilkAdder(address, init);
    }
    
    static fromAddress(address: Address) {
        return new BuilkAdder(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  BuilkAdder_types,
        getters: BuilkAdder_getters,
        receivers: BuilkAdder_receivers,
        errors: BuilkAdder_errors,
    };
